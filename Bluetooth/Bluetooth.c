// Este programa para o PIC16F877A é um comunicador bluetooh, que mostra em um display lcd uma mensagem enviada (MODO SLAVE);
...
void main() {
    ...
    for(;;){
         if(!PIE1.RCIE){                                                        // Se mensagem recebida
               ...
               PIE1.RCIE=1;                                                     //Reabilita a gravação de mensagens no Buffer
         }
    }       
