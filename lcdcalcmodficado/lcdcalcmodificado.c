 ...
 // este programa para o PIC16F877A lê um teclado e funciona como calculadora com um display lcd mas utilizando a biblioteca para keypad
...
void main() {
     ...
     Lcd_Out(1,1,"CALCULATOR"); // Escreve na posição 1,1
     Delay_ms(1000);
     Lcd_Cmd(_LCD_CLEAR); // Limpa o lcd
